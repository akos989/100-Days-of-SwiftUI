...
//        .foregroundColor(.white)
//        .animation(.default, value: enabled) // .animation(nil, value: enabled) -> with nil the change is immidiate
//        .clipShape(RoundedRectangle(cornerRadius: enabled ? 60 : 0))
//        .animation(.interpolatingSpring(stiffness: 10, damping: 1), value: enabled) // animation modifiers work on all the changed modifiers before and after the last animation
